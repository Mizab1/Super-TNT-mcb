...
execute if score @s fuse_time matches 2 run execute at @a[distance=..20] run function mtnt.main:__generated__/execute/886
execute if score @s fuse_time matches 1 run function mtnt.main:__generated__/execute/887
